...
you should place your code here."
  ...
  (setq org-agenda-archives-mode t) ;; agenda clock report包括存档内容
  (setq display-time-mode t) ;; 显示当前时间
