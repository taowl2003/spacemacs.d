...
;; 电脑把org文件同步到该文件夹中
(setq org-mobile-directory "d:/Sync/public/twl/MyFavOp/mobileorg")
;; 电脑要同步哪些org文件
(setq org-mobile-files (list "d:/Sync/CloudStation/orgmode/orgfiles/researchProj.org"
...
;; 上面文件的绝对文件夹
(setq org-directory "d:/Sync/CloudStation/orgmode/orgfiles")
;; 手机端动作记录在这个文件
(setq org-mobile-inbox-for-pull "d:/Sync/public/twl/MyFavOp/mobileorg/mobileRevise.org")
;; 可用的签名文件
